...
import static com.example.music.Fragment.NowPlayingFragmentBottom.playPauseFrBtn;
...
public class PlayerActivity extends AppCompatActivity
    ...
    private Thread playedThread, prevThread, nextThread;
    ...
    private void playedThreadBtn() {
        playedThread = new Thread() {
            @Override
            public void run() {
                super.run();
...
//        metaData(uri);
    ...
    public static void ImageAnimation (Context context, ImageView imageView, Bitmap bitmap) {
